...
public class Principal {
        ...
        do {
            ...
            switch (opt) {
                ...
                case 2: {
                    ...
                    } while (!Email.matches(".+@.+\\.(com|pt|org|net)") || !Telefone.matches("9\\d{8}"));
                    break;
                }
                case 3: {
                    Contact contacto = searchContact(sc);
    ...
    private static Contact createContact(Scanner sc) {
        ...
        return new Contact(0, nome, Integer.parseInt(numero), email, dataNascimento);
    }
        ...
        do {
            ...
            switch (opt) {
                ...
                case 5: {
                    ...
                    int numero = Integer.parseInt(searchContact);
                    for (Contact contacto : contacts) {
